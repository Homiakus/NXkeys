...
HUD показывает допустимые продолжения в трёх колонках. Пути внутри каждого активного модуля уникальны и не являются префиксами других команд. Частые проверенные команды могут иметь безопасный короткий alias.
